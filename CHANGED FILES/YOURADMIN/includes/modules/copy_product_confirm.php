...
// Copy attributes to duplicate product
  ...
  if ($_POST['copy_as'] == 'link') {
    ...
    foreach ($descriptions as $description) {
      $db->Execute("INSERT INTO " . TABLE_PRODUCTS_DESCRIPTION . " (products_id, language_id, products_name, pdf_attachment_name, products_description, products_url, products_viewed)
