 ...
 * @version $Id: preview_info.php for pdf attachment 2017-04-12 07:49:16Z webchills $
 */
if (!defined('IS_ADMIN_FLAG')) {
  die('Illegal Access');
    ...
    if (zen_not_null($_POST)) {
      ...
      $product = $db->Execute("select p.products_id, pd.language_id, pd.products_name, pd.pdf_attachment_name,
...
if ($_POST['products_pdf_attachment_manual'] != '') {
