 ...
 * @version $Id: update_product.php for pdf attachment 2017-04-12 07:49:16Z webchills $
 */
  ...
  if (isset($_POST['edit_x']) || isset($_POST['edit_y'])) {
    $action = 'new_product';
  } elseif ($_POST['products_model'] . $_POST['products_url'] . $_POST['products_name'] . $_POST['pdf_attachment_name'] . $_POST['products_description'] != '') {
    ...
    $sql_data_array['products_pdf_attachment'] = zen_db_prepare_input($_POST['products_pdf_attachment']);
    $new_pdf_attachment= 'true';
